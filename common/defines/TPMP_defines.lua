...
NDefines.NDiplomacy.TENSION_STATE_VALUE = 0.10					-- Tension value gained by annexing one state (this value used to be divided by 20, this is no longer the case)
...
NDefines.NDiplomacy.TENSION_CB_WAR = 7						-- Amount of tension generated by a war with a CB
...
NDefines.NDiplomacy.TENSION_DECAY_DAILY = 0.005					-- Each day tension decays this much for Threat sources which are no longer relevant. Replaces TENSION_DECAY as of 1.12.0
NDefines.NDiplomacy.TENSION_SIZE_FACTOR = 1.0					-- All action tension values are multiplied by this value
NDefines.NDiplomacy.TENSION_TIME_SCALE_START_DATE = "1936.1.1.12"		-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NDefines.NDiplomacy.TENSION_FACTION_JOIN = 4
NDefines.NDiplomacy.TENSION_JOIN_ATTACKER = 2					-- scale of the amount of tension added when country joins attacker side
NDefines.NDiplomacy.TENSION_PEACE_FACTOR = 0.25					-- scale of the amount of tension (from war declaration) reduced when peace is completed. Scaled by current world threat * TENSION_PEACE_FACTOR_THREAT_FACTOR
NDefines.NDiplomacy.TENSION_PEACE_FACTOR_THREAT_FACTOR = 0.60			-- see above
...
NDefines.NDiplomacy.TENSION_DEMILITARIZE_ZONE = 0.25				-- Amount of tension generated by stacking demilitarize zone on 1 state, multiplied with the state base threat
...
NDefines.NDiplomacy.TENSION_DISMANTLE_INDUSTRY = 0.25				-- Amount of tension generated by stacking dismantle military industry on 1 state, multiplied with the state base threat
...
NDefines.NMilitary.COST_INCREASE_PER_ACTIVE_MEDAL = 2		-- Additional cost factor per active medal
...
NDefines.NAir.ANTI_AIR_ATTACK_TO_DAMAGE_REDUCTION_FACTOR = 0.04	-- Balancing value to convert equipment stat anti_air_attack to the damage reduction modifier apply to incoming air attacks against units with AA.
